...
.. figure:: ../img/ch11/robot_learning_overview.png

   An Overview of Common Frameworks for Robot Learning
...
+=============+=========================+==============================+
| 2012        | MuJoCo                  | MuJoCo offers a unique       |
...
|             |                         | contacts.                    |
+-------------+-------------------------+------------------------------+
| 2016        | PyBullet                | PyBullet is an easy to use   |
...
|             |                         | SDK.                         |
+-------------+-------------------------+------------------------------+
| 2016        | Unreal CV               | Unreal CV provides functions |
|             |                         | for perception, navigation,  |
|             |                         | physical simulations, and    |
|             |                         | learning and evaluation of   |
|             |                         | algorithms.                  |
+-------------+-------------------------+------------------------------+
| 2016        | DeepMind Lab            | DeepMind Lab is a            |
...
|             |                         | learning systems.            |
+-------------+-------------------------+------------------------------+
| 2016        | Habitat                 | Habitat-Sim is a flexible,   |
|             |                         | high-performance 3D          |
|             |                         | simulator with configurable  |
|             |                         | agents, sensors, and generic |
|             |                         | 3D dataset handling.         |
+-------------+-------------------------+------------------------------+
| 2017        | AI2-THOR                | AI2-THOR consists of near    |
...
|             |                         | answering.                   |
+-------------+-------------------------+------------------------------+
| 2018        | CHALET                  | CHALET includes rooms and    |
...
|             |                         | environment.                 |
+-------------+-------------------------+------------------------------+
| 2018        | VirtualHome             | VirtualHome simulator allows |
...
+-------------+-------------------------+------------------------------+
| 2019        | VRKitchen               | VRKitchen enables embodied   |
...
|             |                         | demonstration.               |
+-------------+-------------------------+------------------------------+
| 2020        | SAPIEN                  | SAPIEN is a realistic and    |
...
|             |                         | tasks.                       |
+-------------+-------------------------+------------------------------+
| 2020        | ThreeDWorld             | ThreeDWorld is a platform    |
...
+-------------+-------------------------+------------------------------+
| 2021        | Brax                    | Brax is an open-source       |
...
|             |                         | JAX.                         |
+-------------+-------------------------+------------------------------+
| 2021        | iGibson2.0              | iGibson 2.0 supports object  |
|             |                         | states, predicate logic      |
|             |                         | functions, and can sample    |
|             |                         | valid physical states based  |
|             |                         | on logic states.             |
+-------------+-------------------------+------------------------------+
| 2021        | Issac Gym               | Isaac Gym offers a high      |
...
As shown in above table, there are several simulator examples used in
the field.
...
.. figure:: ../img/ch11/real-world.png

   Robot manipulation environments in real world
...
Visual perception is one of the primary sensing modalities for robots,
...
robots to interpret visual data and extract meaningful information.

Tactile Perception:
^^^^^^^^^^^^^^^^^^^

Tactile perception focuses on a robot’s ability to sense and interpret
...
Sound and auditory cues are valuable sources of information for robots.
...
of audio-based information for comprehensive robot perception.
...
(SLAM), and navigation in dynamic environments.
...
monitoring, disaster response, and industrial settings.

Fusion and Integration of Sensing Modalities:
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

To achieve a more comprehensive understanding of the environment, robots
...
Robot perception is a fascinating field that encompasses multiple
...
Heuristic policy refers to a decision-making strategy based on
...
Reinforcement learning (RL) is a powerful approach that enables robots
...
robot gradually discovers the optimal policy for decision-making.

Reinforcement learning consists of the following key elements: - Agent:
...
Affordance learning includes the following steps: - Perception: Sensing
...
.. figure:: ../img/ch11/affordance.png

   Affordance visualization results in robot manipulation tasks

Knowledge Extraction from Large Models:
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

With the advancement of deep learning and large-scale language models,
...
intelligence captured in these models.
...
process by bridging the simulation-to-reality gap.
