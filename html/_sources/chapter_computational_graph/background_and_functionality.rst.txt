...
.. figure:: ../img/ch03/graph.png
   :width: 800px

   Computational graph–based architecture
...
:numref:`dag`. From a top-level view, computational graph technology
provides the following key functions:

-  **Unified representation of the computation process.** Developers
...
-  **Automatic gradient computation.** The training program receives
...
-  **Lifetime analysis of model variables.** During model training, many
...
-  **Execution optimization.** User programs can have different network
